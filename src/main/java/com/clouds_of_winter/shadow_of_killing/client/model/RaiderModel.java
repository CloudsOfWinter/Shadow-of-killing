...
@OnlyIn(Dist.CLIENT)
public class RaiderModel<T extends Monster> extends HumanoidModel<T> {

    public RaiderModel(ModelPart p_170677_) {
        super(p_170677_);
    }
    ...
    public void setupAnim(T p_103798_, float p_103799_, float p_103800_, float p_103801_, float p_103802_, float p_103803_) {
        ...
        if (this.swimAmount > 0.0F) {
            this.rightArm.xRot = this.rotlerpRad(this.swimAmount, this.rightArm.xRot, -2.5132742F) + this.swimAmount * 0.35F * Mth.sin(0.1F * p_103801_);
            this.leftArm.xRot = this.rotlerpRad(this.swimAmount, this.leftArm.xRot, -2.5132742F) - this.swimAmount * 0.35F * Mth.sin(0.1F * p_103801_);
            ...
            this.leftLeg.xRot -= this.swimAmount * 0.55F * Mth.sin(0.1F * p_103801_);
            this.rightLeg.xRot += this.swimAmount * 0.55F * Mth.sin(0.1F * p_103801_);
            this.head.xRot = 0.0F;
        }
    }
}
