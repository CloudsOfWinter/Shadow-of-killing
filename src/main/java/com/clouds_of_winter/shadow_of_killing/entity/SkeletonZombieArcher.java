...
public class SkeletonZombieArcher extends EliteSkeletonZombie {
    public SkeletonZombieArcher(EntityType<? extends SkeletonZombieArcher> p_33570_, Level p_33571_) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return EliteSkeletonZombie.createAttributes()
