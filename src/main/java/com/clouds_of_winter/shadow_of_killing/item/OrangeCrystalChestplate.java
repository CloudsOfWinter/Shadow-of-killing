...
public class OrangeCrystalChestplate extends ArmorItem {
    public OrangeCrystalChestplate(ArmorMaterial p_40386_, EquipmentSlot p_40387_, Properties p_40388_) {
    ...
    public void onArmorTick(ItemStack itemstack, Level level, Player entity) {
        ...
        entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 2, 0, false, false, true));
